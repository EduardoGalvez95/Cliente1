 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://services.ws/", wsdlLocation = "http://localhost:8080/serviciosCrud/Servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://services.ws/", "Servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/serviciosCrud/Servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://services.ws/", "ServiciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.ws/", "ServiciosPort"), Servicios.class, features);
    }
